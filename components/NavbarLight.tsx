        ...
        <nav className="flex h-16 items-center justify-between bg-transparent">
          ...
          <div className="flex items-center gap-4 text-sm">
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link
                href="/#changelogs"
                className="font-semibold text-slate-900/90 hover:text-slate-900 [html[data-theme='dark']_&]:text-slate-100/90 [html[data-theme='dark']_&]:hover:text-slate-100 flex items-center gap-2"
              >
                Changelogs
                <span className="text-xs px-2 py-1 rounded-full bg-slate-200/70 text-slate-700 [html[data-theme='dark']_&]:bg-slate-700/70 [html[data-theme='dark']_&]:text-slate-300">
                  Coming Soon
                </span>
              </Link>
              <Link
          ...
          <div className="md:hidden py-4 border-t border-slate-200 [html[data-theme='dark']_&]:border-slate-700">
            <div className="flex flex-col space-y-3">
              ...
              <Link
                href="/#changelogs"
                onClick={() => setMobileMenuOpen(false)}
                className="px-4 py-2 font-semibold text-slate-900/90 hover:text-slate-900 hover:bg-slate-100 rounded-lg flex items-center gap-2 [html[data-theme='dark']_&]:text-slate-100/90 [html[data-theme='dark']_&]:hover:text-slate-100 [html[data-theme='dark']_&]:hover:bg-slate-800"
              >
                Changelogs
                <span className="text-xs px-2 py-1 rounded-full bg-slate-200/70 text-slate-700 [html[data-theme='dark']_&]:bg-slate-700/70 [html[data-theme='dark']_&]:text-slate-300">
                  Coming Soon
